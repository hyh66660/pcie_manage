    ...
    : QFrame(parent)
{
    ...
    pLabSrcMac->setText(tr("源MAC地址(SRC_MAC)"));
    pLabDestMac->setText(tr("目标MAC地址(DEST_MAC)"));
    ...
    pLayout->addWidget(pLabUnpackRxSpeed, 3, 0);
    pLayout->addWidget(pLabGroupRxSpeed,  3, 2);
    pLayout->addWidget(pLabUnpackTxSpeed, 4, 0);
    pLayout->addWidget(pLabGroupTxSpeed,  4, 2);
    pLayout->addWidget(pLabUnpackMacSrc, 5, 0);
    pLayout->addWidget(pLabUnpackMacDst,  6, 0);
    pLayout->addWidget(pLabGroupMacSrc, 5, 2);
    pLayout->addWidget(pLabGroupMacDst,  6, 2);
    ...
    pLayout->addWidget(pLineEditUnpackRxSpeed,3, 1);
    pLayout->addWidget(pLineEditGroupRxSpeed, 3, 3);
    pLayout->addWidget(pLineEditUnpackTxSpeed,4, 1);
    pLayout->addWidget(pLineEditGroupTxSpeed, 4, 3);
    pLayout->addWidget(pLineEditUnpackMacSrc,5, 1);
    pLayout->addWidget(pLineEditUnpackMacDst, 6, 1);
    pLayout->addWidget(pLineEditGroupMacSrc,5, 3);
    pLayout->addWidget(pLineEditGroupMacDst, 6, 3);
}
